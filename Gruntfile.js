    ...
    grunt.initConfig({
        ...
        less: {
            dev: {
                options: {
                    compress: false,
                    paths: ['<%= config.app %>/less', '<%= config.app %>/lib/bootstrap/less']
                },
                files: {
                    '<%= config.app %>/styles/bootstrap.css': '<%= config.app %>/lib/bootstrap/less/bootstrap.less',
                    '<%= config.app %>/styles/app.css': '<%= config.app %>/less/app.less'
                }
            },
            dist: {
                options: {
